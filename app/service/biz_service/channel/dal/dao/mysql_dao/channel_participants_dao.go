...
func (dao *ChannelParticipantsDAO) Insert(ctx context.Context, do *dataobject.ChannelParticipantsDO) (lastInsertId, rowsAffected int64, err error) {
	var (
		query = "insert into channel_participants(channel_id, user_id, is_creator, read_inbox_max_id, draft_message_data, inviter_user_id, admin_rights, state, date2, available_min_id, available_min_pts) values (:channel_id, :user_id, :is_creator, :read_inbox_max_id, '', :inviter_user_id, :admin_rights, :state, :date2, :available_min_id, :available_min_pts)"
		r     sql.Result
	)
...
func (dao *ChannelParticipantsDAO) InsertBulk(ctx context.Context, doList []*dataobject.ChannelParticipantsDO) (lastInsertId, rowsAffected int64, err error) {
	var (
		query = "insert into channel_participants(channel_id, user_id, is_creator, read_inbox_max_id, draft_message_data, inviter_user_id, admin_rights, migrated_from_max_id, state, date2, available_min_id, available_min_pts, rank) values (:channel_id, :user_id, :is_creator, :read_inbox_max_id, '', :inviter_user_id, :admin_rights, :migrated_from_max_id, :state, :date2, :available_min_id, :available_min_pts, :rank)"
		r     sql.Result
	)
...
func (dao *ChannelParticipantsDAO) SelectByUserIdList(ctx context.Context, channel_id int32, idList []int32) (rList []dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select id, channel_id, user_id, is_creator, is_pinned, order_pinned, read_inbox_max_id, unread_count, unread_mentions_count, unread_mark, draft_type, draft_message_data, folder_id, folder_pinned, folder_order_pinned, inviter_user_id, promoted_by, admin_rights, hidden_prehistory, hidden_prehistory_message_id, kicked_by, banned_rights, banned_until_date, migrated_from_max_id, available_min_id, available_min_pts, rank, state, date2, nickname from channel_participants where channel_id = ? and user_id in (?)"
		a     []interface{}
		rows  *sqlx.Rows
	)
...
func (dao *ChannelParticipantsDAO) SelectByUserId(ctx context.Context, channel_id int32, user_id int32) (rValue *dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select id, channel_id, user_id, is_creator, is_pinned, order_pinned, read_inbox_max_id, unread_count, unread_mentions_count, unread_mark, draft_type, draft_message_data, folder_id, folder_pinned, folder_order_pinned, inviter_user_id, promoted_by, admin_rights, hidden_prehistory, hidden_prehistory_message_id, kicked_by, banned_rights, banned_until_date, migrated_from_max_id, available_min_id, available_min_pts, rank, state, date2, nickname from channel_participants where channel_id = ? and user_id = ?"
		rows  *sqlx.Rows
	)
...
func (dao *ChannelParticipantsDAO) SelectAdminAndBannedList(ctx context.Context, channel_id int32, banned_until_date int32) (rList []dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select id, channel_id, user_id, is_creator, is_pinned, order_pinned, read_inbox_max_id, unread_count, unread_mentions_count, unread_mark, draft_type, draft_message_data, folder_id, folder_pinned, folder_order_pinned, inviter_user_id, promoted_by, admin_rights, hidden_prehistory, hidden_prehistory_message_id, kicked_by, banned_rights, banned_until_date, migrated_from_max_id, available_min_id, available_min_pts, rank, state, date2, nickname from channel_participants where channel_id = ? and (state = 0 and (is_creator = 1 or admin_rights > 0) or (banned_rights > 0 and banned_until_date <= ?))"
		rows  *sqlx.Rows
	)
...
func (dao *ChannelParticipantsDAO) SelectRecentList(ctx context.Context, channel_id int32) (rList []dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select id, channel_id, user_id, is_creator, is_pinned, order_pinned, read_inbox_max_id, unread_count, unread_mentions_count, unread_mark, draft_type, draft_message_data, folder_id, folder_pinned, folder_order_pinned, inviter_user_id, promoted_by, admin_rights, hidden_prehistory, hidden_prehistory_message_id, kicked_by, banned_rights, banned_until_date, migrated_from_max_id, available_min_id, available_min_pts, rank, state, date2, nickname from channel_participants where channel_id = ? and state = 0"
		rows  *sqlx.Rows
	)
	...
	if err != nil {
		log.Errorf("queryx in SelectRecentList(_), error: %v", err)
		return
	}
	...
	for rows.Next() {
		...
		err = rows.StructScan(&v)
		if err != nil {
			log.Errorf("structScan in SelectRecentList(_), error: %v", err)
			return
		}
		values = append(values, v)
	}
...
func (dao *ChannelParticipantsDAO) SelectRecentListOffsetLimit(ctx context.Context, channel_id int32, offset int32, limit int32) (rList []dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select id, channel_id, user_id, is_creator, is_pinned, order_pinned, read_inbox_max_id, unread_count, unread_mentions_count, unread_mark, draft_type, draft_message_data, folder_id, folder_pinned, folder_order_pinned, inviter_user_id, promoted_by, admin_rights, hidden_prehistory, hidden_prehistory_message_id, kicked_by, banned_rights, banned_until_date, migrated_from_max_id, available_min_id, available_min_pts, rank, state, date2, nickname from channel_participants where channel_id = ? and state = 0 order by id asc limit ?, ?"
		rows  *sqlx.Rows
	)
	rows, err = dao.db.Query(ctx, query, channel_id, offset, limit)

	if err != nil {
		log.Errorf("queryx in SelectRecentListOffsetLimit(_), error: %v", err)
		return
	}
	...
	for rows.Next() {
		...
		err = rows.StructScan(&v)
		if err != nil {
			log.Errorf("structScan in SelectRecentListOffsetLimit(_), error: %v", err)
			return
		}
		values = append(values, v)
	}
...
func (dao *ChannelParticipantsDAO) SelectBannedList(ctx context.Context, channel_id int32, banned_until_date int32) (rList []dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select id, channel_id, user_id, is_creator, is_pinned, order_pinned, read_inbox_max_id, unread_count, unread_mentions_count, unread_mark, draft_type, draft_message_data, folder_id, folder_pinned, folder_order_pinned, inviter_user_id, promoted_by, admin_rights, hidden_prehistory, hidden_prehistory_message_id, kicked_by, banned_rights, banned_until_date, migrated_from_max_id, available_min_id, available_min_pts, rank, state, date2, nickname from channel_participants where channel_id = ? and banned_rights > 0 and banned_until_date <= ?"
		rows  *sqlx.Rows
	)
	rows, err = dao.db.Query(ctx, query, channel_id, banned_until_date)
...
func (dao *ChannelParticipantsDAO) SelectKickedList(ctx context.Context, channel_id int32) (rList []dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select id, channel_id, user_id, is_creator, is_pinned, order_pinned, read_inbox_max_id, unread_count, unread_mentions_count, unread_mark, draft_type, draft_message_data, folder_id, folder_pinned, folder_order_pinned, inviter_user_id, promoted_by, admin_rights, hidden_prehistory, hidden_prehistory_message_id, kicked_by, banned_rights, banned_until_date, migrated_from_max_id, available_min_id, available_min_pts, rank, state, date2, nickname from channel_participants where channel_id = ? and state = 2"
		rows  *sqlx.Rows
	)
	...
	if err != nil {
		log.Errorf("queryx in SelectKickedList(_), error: %v", err)
		return
	}
	...
	for rows.Next() {
		...
		err = rows.StructScan(&v)
		if err != nil {
			log.Errorf("structScan in SelectKickedList(_), error: %v", err)
			return
		}
		values = append(values, v)
	}
...
func (dao *ChannelParticipantsDAO) SelectListByUserId(ctx context.Context, user_id int32) (rList []dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select id, channel_id, user_id, is_creator, is_pinned, order_pinned, read_inbox_max_id, unread_count, unread_mentions_count, unread_mark, draft_type, draft_message_data, folder_id, folder_pinned, folder_order_pinned, inviter_user_id, promoted_by, admin_rights, hidden_prehistory, hidden_prehistory_message_id, kicked_by, banned_rights, banned_until_date, migrated_from_max_id, available_min_id, available_min_pts, rank, state, date2, nickname from channel_participants where user_id = ? and state = 0"
		rows  *sqlx.Rows
	)
...
func (dao *ChannelParticipantsDAO) SelectMyAdminList(ctx context.Context, user_id int32) (rList []dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select id, channel_id, user_id, is_creator, is_pinned, order_pinned, read_inbox_max_id, unread_count, unread_mentions_count, unread_mark, draft_type, draft_message_data, folder_id, folder_pinned, folder_order_pinned, inviter_user_id, promoted_by, admin_rights, hidden_prehistory, hidden_prehistory_message_id, kicked_by, banned_rights, banned_until_date, migrated_from_max_id, available_min_id, available_min_pts, rank, state, date2, nickname from channel_participants where user_id = ? and state = 0 and (is_creator = 1 or admin_rights > 0)"
		rows  *sqlx.Rows
	)
	...
	if err != nil {
		log.Errorf("queryx in SelectMyAdminList(_), error: %v", err)
		return
	}
	...
	for rows.Next() {
		...
		err = rows.StructScan(&v)
		if err != nil {
			log.Errorf("structScan in SelectMyAdminList(_), error: %v", err)
			return
		}
		values = append(values, v)
	}
...
func (dao *ChannelParticipantsDAO) SelectUsersChannelIdList(ctx context.Context, idList []int32) (rList []dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select channel_participants.channel_id as channel_id, channel_participants.user_id as user_id from channel_participants, channels where channel_participants.state = 0 and channel_participants.user_id in (?) and channels.id = channel_participants.channel_id and channels.deactivated = 0 and channels.deleted = 0"
		a     []interface{}
		rows  *sqlx.Rows
	)
	query, a, err = sqlx.In(query, idList)
	if err != nil {
		log.Errorf("sqlx.In in SelectUsersChannelIdList(_), error: %v", err)
		return
	}
	rows, err = dao.db.Query(ctx, query, a...)

	if err != nil {
		log.Errorf("queryx in SelectUsersChannelIdList(_), error: %v", err)
		return
	}
	...
	for rows.Next() {
		...
		err = rows.StructScan(&v)
		if err != nil {
			log.Errorf("structScan in SelectUsersChannelIdList(_), error: %v", err)
			return
		}
		values = append(values, v)
	}
...
func (dao *ChannelParticipantsDAO) SelectMyAllChannelList(ctx context.Context, user_id int32) (rList []dataobject.ChannelParticipantsDO, err error) {
	var (
		query = "select id, channel_id, user_id, is_creator, is_pinned, order_pinned, read_inbox_max_id, unread_count, unread_mentions_count, unread_mark, draft_type, draft_message_data, folder_id, folder_pinned, folder_order_pinned, inviter_user_id, promoted_by, admin_rights, hidden_prehistory, hidden_prehistory_message_id, kicked_by, banned_rights, banned_until_date, migrated_from_max_id, available_min_id, available_min_pts, rank, state, date2, nickname from channel_participants where user_id = ? and state = 0"
		rows  *sqlx.Rows
	)
	...
	if err != nil {
		log.Errorf("queryx in SelectMyAllChannelList(_), error: %v", err)
		return
	}
	...
	for rows.Next() {
		...
		err = rows.StructScan(&v)
		if err != nil {
			log.Errorf("structScan in SelectMyAllChannelList(_), error: %v", err)
			return
		}
		values = append(values, v)
	}
