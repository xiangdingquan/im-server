...
import (
	...
	"open.chat/app/service/biz_service/poll/internal/dal/dao/mysql_dao"
...
func newMysqlDao(c *sqlx.Config) *Mysql {
	...
	return &Mysql{
		DB:                  db,
		PollsDAO:            mysql_dao.NewPollsDAO(db),
		PollAnswerVotersDAO: mysql_dao.NewPollAnswerVotersDAO(db),
