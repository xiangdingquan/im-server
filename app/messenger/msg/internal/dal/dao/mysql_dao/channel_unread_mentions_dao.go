...
func (dao *ChannelUnreadMentionsDAO) InsertBulk(ctx context.Context, doList []*dataobject.ChannelUnreadMentionsDO) (lastInsertId, rowsAffected int64, err error) {
	var (
		query = "insert into channel_unread_mentions(user_id, channel_id, mentioned_message_id, deleted) values (:user_id, :channel_id, :mentioned_message_id, 0)"
		r     sql.Result
	)
...
func (dao *ChannelUnreadMentionsDAO) InsertBulkTx(tx *sqlx.Tx, doList []*dataobject.ChannelUnreadMentionsDO) (lastInsertId, rowsAffected int64, err error) {
	var (
		query = "insert into channel_unread_mentions(user_id, channel_id, mentioned_message_id, deleted) values (:user_id, :channel_id, :mentioned_message_id, 0)"
		r     sql.Result
	)
