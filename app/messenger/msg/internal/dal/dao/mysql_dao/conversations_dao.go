...
func (dao *ConversationsDAO) InsertIgnore(ctx context.Context, do *dataobject.ConversationsDO) (lastInsertId, rowsAffected int64, err error) {
	var (
		query = "insert ignore into conversations(user_id, peer_id, top_message, unread_count, draft_message_data, date2) values (:user_id, :peer_id, :top_message, :unread_count, :draft_message_data, :date2)"
		r     sql.Result
	)
...
func (dao *ConversationsDAO) InsertOrUpdate(ctx context.Context, do *dataobject.ConversationsDO) (lastInsertId, rowsAffected int64, err error) {
	var (
		query = "insert into conversations(user_id, peer_id, top_message, unread_count, draft_message_data, date2) values (:user_id, :peer_id, :top_message, :unread_count, '', :date2) on duplicate key update top_message = values(top_message), unread_count = unread_count + values(unread_count), date2 = values(date2)"
		r     sql.Result
	)
...
func (dao *ConversationsDAO) SelectPinnedDialogs(ctx context.Context, user_id int32) (rList []dataobject.ConversationsDO, err error) {
	var (
		query = "select id, user_id, peer_id, is_pinned, top_message, read_inbox_max_id, read_outbox_max_id, unread_count, unread_mark, draft_type, draft_message_data, date2 from conversations where user_id = ? and is_pinned = 1 and deleted = 0 order by top_message desc"
		rows  *sqlx.Rows
	)
...
func (dao *ConversationsDAO) SelectByPeer(ctx context.Context, user_id int32, peer_id int32) (rValue *dataobject.ConversationsDO, err error) {
	var (
		query = "select id, user_id, peer_id, is_pinned, top_message, read_inbox_max_id, read_outbox_max_id, unread_count, unread_mark, draft_type, draft_message_data, date2 from conversations where user_id = ? and peer_id = ? and deleted = 0"
		rows  *sqlx.Rows
	)
...
func (dao *ConversationsDAO) SelectUserDialogs(ctx context.Context, user_id int32) (rList []dataobject.ConversationsDO, err error) {
	var (
		query = "select id, user_id, peer_id, is_pinned, top_message, read_inbox_max_id, read_outbox_max_id, unread_count, unread_mark, draft_type, draft_message_data, date2 from conversations where user_id = ? and deleted = 0"
		rows  *sqlx.Rows
	)
	rows, err = dao.db.Query(ctx, query, user_id)
...
func (dao *ConversationsDAO) SelectByOffsetId(ctx context.Context, user_id int32, top_message int32, limit int32) (rList []dataobject.ConversationsDO, err error) {
	var (
		query = "select id, user_id, peer_id, is_pinned, top_message, read_inbox_max_id, read_outbox_max_id, unread_count, unread_mark, draft_type, draft_message_data, date2 from conversations where user_id = ? and deleted = 0 and top_message > 0 and top_message < ? order by top_message desc limit ?"
		rows  *sqlx.Rows
	)
...
func (dao *ConversationsDAO) SelectExcludePinnedByOffsetId(ctx context.Context, user_id int32, top_message int32, limit int32) (rList []dataobject.ConversationsDO, err error) {
	var (
		query = "select id, user_id, peer_id, is_pinned, top_message, read_inbox_max_id, read_outbox_max_id, unread_count, unread_mark, draft_type, draft_message_data, date2 from conversations where user_id = ? and is_pinned = 0 and deleted = 0 and top_message > 0 and top_message < ? order by top_message desc limit ?"
		rows  *sqlx.Rows
	)
	rows, err = dao.db.Query(ctx, query, user_id, top_message, limit)
...
func (dao *ConversationsDAO) SelectListByPeerList(ctx context.Context, user_id int32, idList []int32) (rList []dataobject.ConversationsDO, err error) {
	var (
		query = "select id, user_id, peer_id, is_pinned, top_message, read_inbox_max_id, read_outbox_max_id, unread_count, unread_mark, draft_type, draft_message_data, date2 from conversations where user_id = ? and deleted = 0 and peer_id in (?)"
		a     []interface{}
		rows  *sqlx.Rows
	)
...
func (dao *ConversationsDAO) SaveDraft(ctx context.Context, draft_message_data string, user_id int32, peer_id int32) (rowsAffected int64, err error) {
	var (
		query   = "update conversations set draft_type = 2, draft_message_data = ? where user_id = ? and peer_id = ?"
		rResult sql.Result
	)
...
func (dao *ConversationsDAO) SelectDraftList(ctx context.Context, user_id int32) (rList []dataobject.ConversationsDO, err error) {
	var (
		query = "select user_id, peer_id, draft_type, draft_message_data from conversations where user_id = ?"
		rows  *sqlx.Rows
	)
	rows, err = dao.db.Query(ctx, query, user_id)
...
func (dao *ConversationsDAO) ClearDraft(ctx context.Context, user_id int32, peer_id int32) (rowsAffected int64, err error) {
	var (
		query   = "update conversations set draft_type = 0, draft_message_data = '' where user_id = ? and peer_id = ?"
		rResult sql.Result
	)
...
func (dao *ConversationsDAO) UpdateDialog(ctx context.Context, top_message int32, unreadCount int32, user_id int32, peer_id int32) (rowsAffected int64, err error) {
	var (
		query   = "update conversations set top_message = ?, unread_count = unread_count + ? where user_id = ? and peer_id = ?"
		rResult sql.Result
	)
	rResult, err = dao.db.Exec(ctx, query, top_message, unreadCount, user_id, peer_id)
...
func (dao *ConversationsDAO) UpdateDialogTx(tx *sqlx.Tx, top_message int32, unreadCount int32, user_id int32, peer_id int32) (rowsAffected int64, err error) {
	var (
		query   = "update conversations set top_message = ?, unread_count = unread_count + ? where user_id = ? and peer_id = ?"
		rResult sql.Result
	)
	rResult, err = tx.Exec(query, top_message, unreadCount, user_id, peer_id)
...
func (dao *ConversationsDAO) UpdateMarkDialogUnread(ctx context.Context, unread_mark int8, user_id int32, peer_id int32) (rowsAffected int64, err error) {
	var (
		query   = "update conversations set unread_mark = ? where user_id = ? and peer_id = ?"
		rResult sql.Result
	)
