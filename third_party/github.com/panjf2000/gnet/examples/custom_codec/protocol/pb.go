...
// Encode ...
func (cc *CustomLengthFieldProtocol) Encode(c gnet.Conn, buf interface{}) ([]byte, error) {
	result := make([]byte, 0)
...
// Decode ...
func (cc *CustomLengthFieldProtocol) Decode(c gnet.Conn) (interface{}, error) {
	// parse header
...
func (cc *CustomLengthFieldProtocol) Clone() gnet.ICodec {
	return cc
}
